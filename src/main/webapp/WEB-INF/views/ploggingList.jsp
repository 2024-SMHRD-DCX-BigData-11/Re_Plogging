		...
		<div class="plocourse-container">
			...
			<div class="Acourse-container fade-up">
		            ...
		            <div class="course-title">
			            ...
			            <span class="course-place">순천대학교</span>
		            </div>
		            <div class="course-img"><img src="img/A코스.png"></div>
		            <div class="course-spot">
		            	...
		            	<ul class="couse-wrap">
		            		<li class="course-box">
		            			<div class="course-innner">01</div>
		            			<img src="img/location.png">
		            			<span class="QR">QR1</span>
		            			<span class="QRNick">열린광장</span>
		            			
		            		</li>
		            		<div class="left-arrow">&gt;</div>
		            		<li class="course-box">
		            			<div class="course-innner">02</div>
		            			<img src="img/location.png">
		            			<span class="QR">QR2</span>
		            			<span class="QRNick">공과대학 1호관</span>
		            		</li>
		            		<div class="left-arrow">&gt;</div>
		            		<li class="course-box">
		            			<div class="course-innner">03</div>
		            			<img src="img/location.png">
		            			<span class="QR">QR3</span>
		            			<span class="QRNick">대학본부</span>
		            		</li>
		            	</ul>
		            </div>
		            ...
		            <div class="Info-title">
		            	<img alt="" src="img/지구.png"><h2>코스 소개</h2>
		            	</div>
		          		<div class="c-Info">
		    ...
		    <div class="Bcourse-container fade-up">
		            ...
		            <div class="course-title">
			            ...
			            <span class="course-place">순천 조례호수공원</span>
		            </div>
		            <div class="course-img"><img src="img/B코스.png"></div>
		            <div class="course-spot">
		            	<div class="spot-title">
		            	<img alt="" src="img/지구.png"><h2>B코스 경유지</h2>
		            	</div>
		            	<ul class="couse-wrap">
		            		<li class="course-box">
		            			<div class="course-innner">01</div>
		            ...
		            <div class="Info-title">
		            	<img alt="" src="img/지구.png"><h2>코스 소개</h2>
		          		...
		          		<div class="c-Info">
		          			<span>조례호수공원은 호수를 중심으로 한 산책로와 넓은 광장, 분수대 등이 조성되어 있어 플로깅을 하기에 탁월한 장소입니다.<br>
		          			공원은 자연 속에서 편안한 산책과 플로깅을 즐길 수 있는 공간으로, 순천 시민들의 건강 증진과 여가 생활을 위한 도심 속 쉼터 역할을 합니다.<br>
		    ...
		    <div class="Ccourse-container fade-up">
		            ...
		            <div class="course-title">
			            ...
			            <span class="course-place">순천 오천그린광장</span>
		            </div>
		            <div class="course-img"><img src="img/C코스.png"></div>
		            <div class="course-spot">
		            	<div class="spot-title">
		            	<img alt="" src="img/지구.png"><h2>C코스 경유지</h2>
		            	</div>
		            	<ul class="couse-wrap">
		            		<li class="course-box">
		            			<div class="course-innner">01</div>
		            ...
		            <div class="Info-title">
		            	<img alt="" src="img/지구.png"><h2>코스 소개</h2>
		          		...
		          		<div class="c-Info">
		          			<span>오천그린광장은 대규모 저류지를 정원으로 탈바꿈시킨 독특한 공간으로,<br>
		          			다양한 수목과 어싱길이 조성되어 있어 자연과 함께하는 산책과 플로깅에 최적화된 장소입니다.<br>
		          			사계절 내내 푸른 잔디와 어싱길은 운동 중 발의 피로를 줄여주며, 쾌적한 환경에서 플로깅을 즐길 수 있습니다.<br>
